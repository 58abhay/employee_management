...
class Employee :
    def __init__(self,root) :
        ...
        # logo
        img_logo = Image.open('images/icon.png')
        ...
        #Add Employee Image
        employeeImg= Image.open('images/pass1.png')
    ...
    def AddData(self):
        ...
        conn = mysql.connector.connect(host="localhost",user="root",password="root",database="myemployee")
        cursor = conn.cursor()
        try:
    ...
    def deleteData(self):
        conn = mysql.connector.connect(host="localhost",username="root",password="root",database="myemployee")
        cursor= conn.cursor()
